(function(exports){
  ...
  cubism_contextPrototype.horizon = function(o=0) {
    var context = this,
        mode = "offset",
    ...
    function horizon(selection) {
      ...
      selection   
          .on("mousemove.horizon", function() { context.focus(Math.round(d3.mouse(this)[0]-o)); })
    ...
    horizon.remove = function(selection) {
      ...
      selection.selectAll(".title,.value,.border")
          .remove();
  ...
  cubism_contextPrototype.axis = function(o) {
    var context = this,
        scale = context.scale,
    ...
    function axis(selection) {
      ...
      var g = selection.append("svg")
          .datum({id: id})
          .attr("width", context.size()+offset)
